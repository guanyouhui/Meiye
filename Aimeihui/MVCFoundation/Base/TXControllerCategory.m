//
//  TXViewController+TXController.m
//  Yundx
//
...
- (void)customNavigationBar {
    ...
    [navigationBar setBackgroundImage:[ZUtilsImage getImageWithColor:SUBJECT_COLOR] forBarMetrics:UIBarMetricsDefault];
...
- (void)customBackButton {
    ...
    UIButton *backButton = [self addLeftNavBarItemsWithText:nil andImage:[UIImage imageNamed:@"user_back.png"]];
...
- (UIButton *)addRightNavBarItemsWithText:(NSString *)text andImage:(UIImage *)image action:(SEL)action{
    UIButton * itemButton = [self addRightNavBarItemsWithText:text andImage:image];
    [itemButton addTarget:self action:action forControlEvents:UIControlEventTouchUpInside];
    return itemButton;
}

- (UIButton *)addLeftNavBarItemsWithText:(NSString *)text andImage:(UIImage *)image action:(SEL)action{
    
    UIButton * itemButton = [self addLeftNavBarItemsWithText:text andImage:image];
    [itemButton addTarget:self action:action forControlEvents:UIControlEventTouchUpInside];
    return itemButton;
}
