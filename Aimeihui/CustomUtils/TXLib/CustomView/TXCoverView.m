...
#import "TXCoverView.h"
#import <QuartzCore/QuartzCore.h>
#import <Accelerate/Accelerate.h>

@interface TXCoverView()
...
@implementation TXCoverView

- (TXCoverView*)initWithTableViewWithHeaderImage:(UIImage*)headerImage withOTCoverHeight:(CGFloat)height{
    
    CGRect bounds = [[UIScreen mainScreen] bounds];
    self = [[TXCoverView alloc] initWithFrame:bounds];
    
    
    
    self.tableHeadContentView = [[UIView alloc]initWithFrame:CGRectMake(0, 0, bounds.size.width, headerImage.size.height)];
    self.tableHeadContentView.backgroundColor = [UIColor clearColor];
    [self addSubview:self.tableHeadContentView];
    
    self.headerImageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, bounds.size.width, headerImage.size.height)];
    self.headerImageView.userInteractionEnabled = YES;
    [self.headerImageView setImage:headerImage];
    [self.tableHeadContentView addSubview:self.headerImageView];
...
- (TXCoverView*)initWithScrollViewWithHeaderImage:(UIImage*)headerImage withOTCoverHeight:(CGFloat)height withScrollContentViewHeight:(CGFloat)ContentViewheight{
