...
{
    BOOL isPortrait = UIDeviceOrientationIsPortrait((UIDeviceOrientation)orientation);
    CGFloat statusBarHeight = 20.0f;
    if ([UIApplication sharedApplication].statusBarHidden)
        statusBarHeight = 0.0f;
    if (isPortrait)
                                     ...
                                     userInfo:(id)userInfo
{
    return [self notifyWithText:text
                         detail:detail
                    andDuration:2.0 userInfo:userInfo];
}
                                     ...
                                     userInfo:(id)userInfo
{
    return [self notifyWithText:text
                         detail:detail
                          image:nil
                    andDuration:duration userInfo:userInfo];
}
                                     ...
                                     userInfo:(id)userInfo
{
    return [self notifyWithText:text
                         detail:detail
                          image:image
                       duration:duration
                  andTouchBlock:nil userInfo:userInfo];
}
                                     ...
                                     userInfo:(id)userInfo
{
    return [self notifyWithText:text
                         detail:detail
                          image:nil
                       duration:duration
                  andTouchBlock:block userInfo:userInfo];
}
                                     ...
                                     userInfo:(id)userInfo
{
    ...
    notification.o_userInfo = userInfo;
