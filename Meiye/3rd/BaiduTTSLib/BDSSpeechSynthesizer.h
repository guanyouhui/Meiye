...
enum BDSPlayerError {
    BDS_PLAYER_FAILED_GET_STREAM_PROPERTIES = 8001,
...
/** 设置user-agent */
FOUNDATION_EXPORT NSString * const BDS_PARAM_USER_AGENT;
 ...
 *        synthesizerNewDataArrived:data:isLastData:方法传回的数据自行播放
 *
